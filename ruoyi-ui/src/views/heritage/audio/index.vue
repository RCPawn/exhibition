<template>
  <div class="app-container heritage-admin-page">
    <div class="heritage-toolbar-row">
      <h2 class="page-title heritage-toolbar-row__title">音频管理</h2>
      <el-form
        :model="queryParams"
        ref="queryRef"
        :inline="true"
      ...
      >
        <el-form-item prop="title">
          <el-input v-model="queryParams.title" placeholder="音频标题" clearable @keyup.enter="handleQuery" style="width: 168px" />
        </el-form-item>
